...
public class CheckoutSuccessPag {
	 WebDriver driver;
	    WebDriverWait wait;
	    ...
	    public CheckoutSuccessPag(WebDriver driver2, WebDriverWait wait2) {
			// TODO Auto-generated constructor stub
		}

		public void CheckoutSuccessPage(WebDriver driver, WebDriverWait wait){
	        this.driver = driver;
	        this.wait = wait;
	    }
